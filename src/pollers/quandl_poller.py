...
# from src.config import get_quandl_api_key, get_rate_limit, get_quandl_fill_rate_limit
...
#         self.rate_limiter = RateLimiter(max_requests=get_quandl_fill_rate_limit(), time_window=60)
